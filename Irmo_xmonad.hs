...
startupCommands = ["xrandr --output HDMI-1 --right-of DP-1"
		  ,"feh -g +0+300 --bg-fill /home/ben/Pictures/Irmo.jpg"
		  ,"skypeforlinux"
		  ]
...
myTopics :: [TopicItem]
myTopics = [TI "dashboard"  homedir                       $ spawn' "Agathion" "/home/ben/Computer/agathion/agathion"
           ,TI "web"        homedir                       $ spawn "vivaldi"
           ...
           ,TI "steam"      (homedir++"/home/ben/Games")  $ spawn "steam"
           ]
...
myXPConfig = defaultXPConfig
  { position = Top, promptBorderWidth = 0, height = 22
  , font = "xft:Hack:Regular:size=12", bgColor = "#222222"
...
search' :: String -> X ()
search' s = search "vivaldi" (use engine) query
